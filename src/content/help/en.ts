...
export const helpCatalogueEn: HelpCatalogue = [
  ...
  },
  {
    ...
    steps: [
      "Open “Inventory” in the sidebar. The tiles at the top count the units in total, working, damaged, in a warehouse and on site.",
      "Click “Warehouses” to add the places the company keeps its tools, each with a name and an address; a warehouse still holding units cannot be deleted.",
      "Click “Add equipment”: name — required — category, quantity, working or damaged, then where it is: a warehouse or one of your sites. A reference or serial number and notes are optional.",
      "The list is grouped by place, warehouses first. Use the search field and the place, condition and warehouse selects to narrow it.",
      "Use the pencil on a row to change anything about it — mark it damaged after it breaks, move it from the warehouse to a site, adjust the quantity — and the bin to remove it.",
    ],
    whoCanDoIt:
      "Anyone attached to a company can read it. The add, edit and delete controls are always shown, but the server refuses changes unless you hold the inventory-management permission and tells you so.",
    gotchas: [
      ...
      "The inventory belongs to one company — your primary one — and there is no company picker.",
    ],
  },
  {
    id: "billing-devis",
