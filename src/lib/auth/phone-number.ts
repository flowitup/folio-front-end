 ...
 * what the user types ("06 12 34 56 78", "+33 6 12 34 56 78", "0033…") and turns it into E.164 for
 * the backend. A number from any other country is refused before a code is ever requested.
 *
